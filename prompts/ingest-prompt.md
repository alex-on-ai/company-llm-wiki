...
The context model is step one. This prompt is step two: turn your company folder into a small **LLM wiki** — every document you drop in enriches the linked knowledge base AND produces the work you need from it. (Pattern: Andrej Karpathy's "LLM wiki" — raw sources in, maintained linked pages out.)
